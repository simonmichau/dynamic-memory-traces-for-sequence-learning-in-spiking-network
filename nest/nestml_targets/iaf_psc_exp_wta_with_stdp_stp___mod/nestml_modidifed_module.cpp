...
#include "nestml_modidifed_module.h"
...
nestml_modidifed_module nestml_modidifed_module_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

nestml_modidifed_module::nestml_modidifed_module()
{
#ifdef LINKED_MODULE
...
const std::string
nestml_modidifed_module::name(void) const
{
  return std::string("nestml_modidifed_module"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
nestml_modidifed_module::init( SLIInterpreter* i )
{
