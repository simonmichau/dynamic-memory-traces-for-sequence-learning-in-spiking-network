 ...
 *  stdp_solo__with_iaf_psc_exp_wta.h
 *
 ...
 *
 *  Generated from NESTML at time: 2022-09-06 14:45:58.589945
**/

#ifndef STDP_SOLO__WITH_IAF_PSC_EXP_WTA_H
#define STDP_SOLO__WITH_IAF_PSC_EXP_WTA_H
...
#define POST_NEURON_TYPE iaf_psc_exp_wta__with_stdp_solo
...
namespace stdp_solo__with_iaf_psc_exp_wta_names
{
    const Name _w( "w" );
...
class stdp_solo__with_iaf_psc_exp_wtaCommonSynapseProperties : public CommonSynapseProperties {
public:

    stdp_solo__with_iaf_psc_exp_wtaCommonSynapseProperties()
...
class stdp_solo__with_iaf_psc_exp_wta : public Connection< targetidentifierT >
{
private:
  double t_lastspike_;
  ...
  */
  struct Parameters_{    /* generated by directives/MemberDeclaration.jinja2 */
    ...
    double tau_tr_pre;/* generated by directives/MemberDeclaration.jinja2 */
    //!  postsynaptic time constant
    double tau_tr_post;/* generated by directives/MemberDeclaration.jinja2 */
  ...
  **/
  inline void
  update_internal_state_(double t_start, double timestep, const stdp_solo__with_iaf_psc_exp_wtaCommonSynapseProperties& cp);
...
public:
  ...
  typedef stdp_solo__with_iaf_psc_exp_wtaCommonSynapseProperties CommonPropertiesType;
  ...
  */
  stdp_solo__with_iaf_psc_exp_wta();
  ...
  */
  stdp_solo__with_iaf_psc_exp_wta( const stdp_solo__with_iaf_psc_exp_wta& rhs );
...
*/
    ...
    const CommonPropertiesType& cp )
  {
    ...
    try {
      dynamic_cast<iaf_psc_exp_wta__with_stdp_solo&>(t);
    }
    catch (std::bad_cast &exp) {
      std::cout << "wrong type of neuron connected! Synapse 'stdp_solo__with_iaf_psc_exp_wta' will only work with neuron 'iaf_psc_exp_wta__with_stdp_solo'.\n";
      exit(1);
    }
  ...
  void
  send( Event& e, const thread tid, const stdp_solo__with_iaf_psc_exp_wtaCommonSynapseProperties& cp )
  {
...
#ifdef DEBUG
    std::cout << "stdp_solo__with_iaf_psc_exp_wta::send(): handling pre spike at t = " << __t_spike << std::endl;
#endif
    // use accessor functions (inherited from Connection< >) to obtain delay and target
    iaf_psc_exp_wta__with_stdp_solo* __target = static_cast<iaf_psc_exp_wta__with_stdp_solo*>(get_target(tid));
...

    {
      ...
      **//* generated by directives/Block.jinja2 */ /* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/FunctionCall.jinja2 */
      std::cout << "Post spike: y(t)=" << get_y() << " ";/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Declaration.jinja2 */
      double delta_w = get_y() * P_.c * std::exp((-(get_w()))) - 1;/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Assignment.jinja2 */
          S_.w += delta_w;
    ...
    **//* generated by directives/Block.jinja2 */ /* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/FunctionCall.jinja2 */
    std::cout << "Pre spike: y(t)=" << get_y() << " ";/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Declaration.jinja2 */
    double delta_w = get_y() * P_.c * std::exp((-(get_w()))) - 1;/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Assignment.jinja2 */
        S_.w += delta_w;/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/FunctionCall.jinja2 */
    ...
    **/
    ...
    if (pre_before_post_flag)
    {
      ...
      **/
      ...
      #endif/* generated by directives/Block.jinja2 */ /* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/FunctionCall.jinja2 */
      std::cout << "Post spike: y(t)=" << get_y() << " ";/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Declaration.jinja2 */
      double delta_w = get_y() * P_.c * std::exp((-(get_w()))) - 1;/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Assignment.jinja2 */
          S_.w += delta_w;
#ifdef DEBUG
...
template < typename targetidentifierT >
void
stdp_solo__with_iaf_psc_exp_wta< targetidentifierT >::get_status( DictionaryDatum& __d ) const
{
  ...
  def<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_tau_tr_pre, get_tau_tr_pre());  /* generated by directives/WriteInDictionary.jinja2 */
  def<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_tau_tr_post, get_tau_tr_post());  /* generated by directives/WriteInDictionary.jinja2 */
  def<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_tau_rise, get_tau_rise());  /* generated by directives/WriteInDictionary.jinja2 */
  def<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_tau_decay, get_tau_decay());  /* generated by directives/WriteInDictionary.jinja2 */
  def<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_c, get_c());

  // initial values for state variables in ODE or kernel  /* generated by directives/WriteInDictionary.jinja2 */
  def<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_w, get_w());
  ...
  def<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_decay_time_kernel__X__pre_spikes, get_decay_time_kernel__X__pre_spikes());/* generated by directives/WriteInDictionary.jinja2 */
  def<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_rise_time_kernel__X__pre_spikes, get_rise_time_kernel__X__pre_spikes());
}

template < typename targetidentifierT >
void
stdp_solo__with_iaf_psc_exp_wta< targetidentifierT >::set_status( const DictionaryDatum& __d,
  ConnectorModel& cm )
{
  // parameters  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  double tmp_d = get_d();
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_d, tmp_d);  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  double tmp_tau_tr_pre = get_tau_tr_pre();
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_tau_tr_pre, tmp_tau_tr_pre);  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  double tmp_tau_tr_post = get_tau_tr_post();
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_tau_tr_post, tmp_tau_tr_post);  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  double tmp_tau_rise = get_tau_rise();
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_tau_rise, tmp_tau_rise);  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  double tmp_tau_decay = get_tau_decay();
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_tau_decay, tmp_tau_decay);  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  double tmp_c = get_c();
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_c, tmp_c);

  // initial values for state variables in ODE or kernel  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  double tmp_w = get_w();
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_w, tmp_w);
  ...
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_decay_time_kernel__X__pre_spikes, tmp_decay_time_kernel__X__pre_spikes);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  double tmp_rise_time_kernel__X__pre_spikes = get_rise_time_kernel__X__pre_spikes();
  updateValue<double>(__d, nest::stdp_solo__with_iaf_psc_exp_wta_names::_rise_time_kernel__X__pre_spikes, tmp_rise_time_kernel__X__pre_spikes);
  ...
  set_tau_tr_pre(tmp_tau_tr_pre);  /* generated by directives/AssignTmpDictionaryValue.jinja2 */
  set_tau_tr_post(tmp_tau_tr_post);  /* generated by directives/AssignTmpDictionaryValue.jinja2 */
...
**/
template < typename targetidentifierT >
void stdp_solo__with_iaf_psc_exp_wta< targetidentifierT >::recompute_internal_variables()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
**/
template < typename targetidentifierT >
stdp_solo__with_iaf_psc_exp_wta< targetidentifierT >::stdp_solo__with_iaf_psc_exp_wta() : ConnectionBase()
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
  /* generated by directives/MemberInitialization.jinja2 */
  P_.d = 1.0; // as ms
  /* generated by directives/MemberInitialization.jinja2 */
  P_.tau_tr_pre = 15; // as ms
  /* generated by directives/MemberInitialization.jinja2 */
  P_.tau_tr_post = 30; // as ms
  /* generated by directives/MemberInitialization.jinja2 */
  P_.tau_rise = 2; // as ms
  /* generated by directives/MemberInitialization.jinja2 */
...
**/
template < typename targetidentifierT >
stdp_solo__with_iaf_psc_exp_wta< targetidentifierT >::stdp_solo__with_iaf_psc_exp_wta( const stdp_solo__with_iaf_psc_exp_wta< targetidentifierT >& rhs )
: ConnectionBase( rhs )
{
    P_.d = rhs.P_.d;
...
template < typename targetidentifierT >
inline void
stdp_solo__with_iaf_psc_exp_wta< targetidentifierT >::update_internal_state_(double t_start, double timestep, const stdp_solo__with_iaf_psc_exp_wtaCommonSynapseProperties& cp)
{
  if (timestep < 1E-12)
  {
#ifdef DEBUG
...
#endif /* #ifndef STDP_SOLO__WITH_IAF_PSC_EXP_WTA_H */