 ...
 *
 *  Generated from NESTML at time: 2022-09-07 10:37:33.517865
**/
...
inline void iaf_psc_exp_wta::get_status(DictionaryDatum &__d) const
{
  ...
  def<double>(__d, nest::iaf_psc_exp_wta_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());
...
inline void iaf_psc_exp_wta::set_status(const DictionaryDatum &__d)
{
  ...
  updateValue<double>(__d, nest::iaf_psc_exp_wta_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  updateValue<double>(__d, nest::iaf_psc_exp_wta_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes);
