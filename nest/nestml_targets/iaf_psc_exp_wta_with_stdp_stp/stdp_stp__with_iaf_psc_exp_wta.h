 ...
 *
 *  Generated from NESTML at time: 2022-09-06 14:32:28.570647
**/
...
stdp_stp__with_iaf_psc_exp_wta< targetidentifierT >::get_status( DictionaryDatum& __d ) const
{
  ...
  def<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_tau_tr_post, get_tau_tr_post());
  ...
  ConnectorModel& cm )
{
  ...
  updateValue<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_tau_tr_post, tmp_tau_tr_post);
