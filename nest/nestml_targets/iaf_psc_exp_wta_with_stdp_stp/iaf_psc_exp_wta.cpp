...
template <> void RecordablesMap<iaf_psc_exp_wta>::create()
  {
   ...
   insert_(iaf_psc_exp_wta_names::_rise_time_kernel__X__exc_spikes, &iaf_psc_exp_wta::get_rise_time_kernel__X__exc_spikes);
   insert_(iaf_psc_exp_wta_names::_decay_time_kernel__X__exc_spikes, &iaf_psc_exp_wta::get_decay_time_kernel__X__exc_spikes);
...
void iaf_psc_exp_wta::update(nest::Time const & origin,const long from, const long to)
{
  ...
  S_.V_m = V_m__tmp;
  S_.rise_time_kernel__X__exc_spikes = rise_time_kernel__X__exc_spikes__tmp;
  S_.decay_time_kernel__X__exc_spikes = decay_time_kernel__X__exc_spikes__tmp;/* generated by directives/ApplySpikesFromBuffers.jinja2 */ /* generated by directives/Assignment.jinja2 */ 
      S_.rise_time_kernel__X__exc_spikes += (B_.exc_spikes_grid_sum_) / (1.0);/* generated by directives/Assignment.jinja2 */ 
      S_.decay_time_kernel__X__exc_spikes += (B_.exc_spikes_grid_sum_) / (1.0);/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Assignment.jinja2 */ 
