...
template <> void RecordablesMap<iaf_psc_exp_wta__with_stdp_stp>::create()
  {
   ...
   insert_(iaf_psc_exp_wta__with_stdp_stp_names::_decay_time_kernel__X__exc_spikes, &iaf_psc_exp_wta__with_stdp_stp::get_decay_time_kernel__X__exc_spikes);
   insert_(iaf_psc_exp_wta__with_stdp_stp_names::_rise_time_kernel__X__exc_spikes, &iaf_psc_exp_wta__with_stdp_stp::get_rise_time_kernel__X__exc_spikes);
...
iaf_psc_exp_wta__with_stdp_stp::iaf_psc_exp_wta__with_stdp_stp():ArchivingNode(), P_(), S_(), B_(*this)
{
  ...
  // initial values for state variables
    ...
    S_.V_m = 0; // as mV
    /* generated by directives/MemberInitialization.jinja2 */ 
    S_.decay_time_kernel__X__exc_spikes = 0; // as real
    /* generated by directives/MemberInitialization.jinja2 */ 
    S_.rise_time_kernel__X__exc_spikes = 0; // as real
...
iaf_psc_exp_wta__with_stdp_stp::iaf_psc_exp_wta__with_stdp_stp(const iaf_psc_exp_wta__with_stdp_stp& __n):
  ...
  S_.r = __n.S_.r;
  S_.V_m = __n.S_.V_m;
  S_.decay_time_kernel__X__exc_spikes = __n.S_.decay_time_kernel__X__exc_spikes;
  S_.rise_time_kernel__X__exc_spikes = __n.S_.rise_time_kernel__X__exc_spikes;
  ...
  V_.__P__decay_time_kernel__X__exc_spikes__decay_time_kernel__X__exc_spikes = __n.V_.__P__decay_time_kernel__X__exc_spikes__decay_time_kernel__X__exc_spikes;
  V_.__P__rise_time_kernel__X__exc_spikes__rise_time_kernel__X__exc_spikes = __n.V_.__P__rise_time_kernel__X__exc_spikes__rise_time_kernel__X__exc_spikes;
...
void iaf_psc_exp_wta__with_stdp_stp::recompute_internal_variables(bool exclude_timestep) {
  ...
  if (exclude_timestep) {    
      ...
      /* generated by directives/MemberInitialization.jinja2 */ 
      V_.__P__decay_time_kernel__X__exc_spikes__decay_time_kernel__X__exc_spikes = std::exp((-(V_.__h)) / P_.tau_m); // as real
      /* generated by directives/MemberInitialization.jinja2 */ 
      V_.__P__rise_time_kernel__X__exc_spikes__rise_time_kernel__X__exc_spikes = std::exp((-(V_.__h)) / P_.tau_syn_exc); // as real
  }
  else {
    // internals V_
      /* generated by directives/MemberInitialization.jinja2 */ 
...
void iaf_psc_exp_wta__with_stdp_stp::update(nest::Time const & origin,const long from, const long to)
{
  ...
  double decay_time_kernel__X__exc_spikes__tmp = V_.__P__decay_time_kernel__X__exc_spikes__decay_time_kernel__X__exc_spikes * get_decay_time_kernel__X__exc_spikes();
  double rise_time_kernel__X__exc_spikes__tmp = V_.__P__rise_time_kernel__X__exc_spikes__rise_time_kernel__X__exc_spikes * get_rise_time_kernel__X__exc_spikes();
  ...
  S_.V_m = V_m__tmp;
  S_.decay_time_kernel__X__exc_spikes = decay_time_kernel__X__exc_spikes__tmp;
  S_.rise_time_kernel__X__exc_spikes = rise_time_kernel__X__exc_spikes__tmp;/* generated by directives/ApplySpikesFromBuffers.jinja2 */ /* generated by directives/Assignment.jinja2 */ 
      S_.decay_time_kernel__X__exc_spikes += (B_.exc_spikes_grid_sum_) / (1.0);/* generated by directives/Assignment.jinja2 */ 
      S_.rise_time_kernel__X__exc_spikes += (B_.exc_spikes_grid_sum_) / (1.0);/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Assignment.jinja2 */ 
