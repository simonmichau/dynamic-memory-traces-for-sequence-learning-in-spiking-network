 ...
 *  iaf_psc_exp_wta__with_stdp.cpp
 *
...
#include "iaf_psc_exp_wta__with_stdp.h"

// ---------------------------------------------------------------------------
//   Recordables map
// ---------------------------------------------------------------------------
nest::RecordablesMap<iaf_psc_exp_wta__with_stdp> iaf_psc_exp_wta__with_stdp::recordablesMap_;
namespace nest
{

  // Override the create() method with one call to RecordablesMap::insert_()
  // for each quantity to be recorded.
template <> void RecordablesMap<iaf_psc_exp_wta__with_stdp>::create()
  {
    // add state variables to recordables map
   insert_(iaf_psc_exp_wta__with_stdp_names::_V_m, &iaf_psc_exp_wta__with_stdp::get_V_m);
   insert_(iaf_psc_exp_wta__with_stdp_names::_I_kernel_exc__X__exc_spikes, &iaf_psc_exp_wta__with_stdp::get_I_kernel_exc__X__exc_spikes);
   insert_(iaf_psc_exp_wta__with_stdp_names::_I_kernel_inh__X__inh_spikes, &iaf_psc_exp_wta__with_stdp::get_I_kernel_inh__X__inh_spikes);
   insert_(iaf_psc_exp_wta__with_stdp_names::_normalization_sum, &iaf_psc_exp_wta__with_stdp::get_normalization_sum);
...
//   is a part of iaf_psc_exp_wta__with_stdp's constructor.
// ---------------------------------------------------------------------------

iaf_psc_exp_wta__with_stdp::Parameters_::Parameters_()
{
}

iaf_psc_exp_wta__with_stdp::State_::State_()
{
}
...
iaf_psc_exp_wta__with_stdp::Buffers_::Buffers_(iaf_psc_exp_wta__with_stdp &n):
  logger_(n)
{
  // Initialization of the remaining members is deferred to init_buffers_().
}

iaf_psc_exp_wta__with_stdp::Buffers_::Buffers_(const Buffers_ &, iaf_psc_exp_wta__with_stdp &n):
  logger_(n)
{
  // Initialization of the remaining members is deferred to init_buffers_().
}
...
iaf_psc_exp_wta__with_stdp::iaf_psc_exp_wta__with_stdp():ArchivingNode(), P_(), S_(), B_(*this)
{
...
iaf_psc_exp_wta__with_stdp::iaf_psc_exp_wta__with_stdp(const iaf_psc_exp_wta__with_stdp& __n):
...
iaf_psc_exp_wta__with_stdp::~iaf_psc_exp_wta__with_stdp()
{
}
...
void iaf_psc_exp_wta__with_stdp::init_buffers_()
{
...
void iaf_psc_exp_wta__with_stdp::recompute_internal_variables(bool exclude_timestep) {
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void iaf_psc_exp_wta__with_stdp::pre_run_hook() {
  B_.logger_.init();
...
void iaf_psc_exp_wta__with_stdp::update(nest::Time const & origin,const long from, const long to)
{
  const double __resolution = nest::Time::get_resolution().get_ms();  // do not remove, this is necessary for the resolution() function
...
void iaf_psc_exp_wta__with_stdp::handle(nest::DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}

void iaf_psc_exp_wta__with_stdp::handle(nest::SpikeEvent &e)
{
...
void iaf_psc_exp_wta__with_stdp::handle(nest::CurrentEvent& e)
{
  assert(e.get_delay_steps() > 0);
...
void iaf_psc_exp_wta__with_stdp::handle(nest::InstantaneousRateConnectionEvent& e)
{
...
inline double
iaf_psc_exp_wta__with_stdp::get_spiketime_ms() const
{
  return last_spike_;
}
...
void
iaf_psc_exp_wta__with_stdp::register_stdp_connection( double t_first_read, double delay )
{
  ...
  for ( std::deque< histentry__iaf_psc_exp_wta__with_stdp >::iterator runner = history_.begin();
...
void
iaf_psc_exp_wta__with_stdp::get_history__( double t1,
  double t2,
  ...
  std::deque< histentry__iaf_psc_exp_wta__with_stdp >::iterator* finish )
{
  *finish = history_.end();
  ...
  std::deque< histentry__iaf_psc_exp_wta__with_stdp >::reverse_iterator runner = history_.rbegin();
...
void
iaf_psc_exp_wta__with_stdp::set_spiketime( nest::Time const& t_sp, double offset )
{
    ...
    last_spike_ = t_sp_ms;
    history_.push_back( histentry__iaf_psc_exp_wta__with_stdp( last_spike_
, 0
 ) );
  }
  else
...
void
iaf_psc_exp_wta__with_stdp::clear_history()
{
  last_spike_ = -1.0;
  history_.clear();
}
