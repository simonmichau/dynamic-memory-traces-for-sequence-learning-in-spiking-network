 ...
 *
 *  Generated from NESTML at time: 2022-09-09 08:42:47.904882
**/
#ifndef IAF_PSC_EXP_WTA__WITH_STDP
#define IAF_PSC_EXP_WTA__WITH_STDP
...
namespace nest
{
namespace iaf_psc_exp_wta__with_stdp_names
{
    const Name _r( "r" );
    const Name _V_m( "V_m" );
...
class histentry__iaf_psc_exp_wta__with_stdp
{
public:
  histentry__iaf_psc_exp_wta__with_stdp( double t,
...
/* BeginDocumentation
  Name: iaf_psc_exp_wta__with_stdp.
...
*/
class iaf_psc_exp_wta__with_stdp : public nest::ArchivingNode
{
public:
  /**
   * The constructor is only used to create the model prototype in the model manager.
  **/
  iaf_psc_exp_wta__with_stdp();
  ...
  **/
  iaf_psc_exp_wta__with_stdp(const iaf_psc_exp_wta__with_stdp &);
...
private:
  ...
  std::deque< histentry__iaf_psc_exp_wta__with_stdp > history_;
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_exp_wta__with_stdp>;
  friend class nest::UniversalDataLogger<iaf_psc_exp_wta__with_stdp>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_exp_wta__with_stdp &);
    Buffers_(const Buffers_ &, iaf_psc_exp_wta__with_stdp &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_exp_wta__with_stdp> logger_;
  ...
  static nest::RecordablesMap<iaf_psc_exp_wta__with_stdp> recordablesMap_;

}; /* neuron iaf_psc_exp_wta__with_stdp */

inline nest::port iaf_psc_exp_wta__with_stdp::send_test_event(nest::Node& target, nest::rport receptor_type, nest::synindex, bool)
{
...
inline nest::port iaf_psc_exp_wta__with_stdp::handles_test_event(nest::SpikeEvent&, nest::port receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest::port iaf_psc_exp_wta__with_stdp::handles_test_event(nest::CurrentEvent&, nest::port receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port iaf_psc_exp_wta__with_stdp::handles_test_event(nest::DataLoggingRequest& dlr, nest::port receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port iaf_psc_exp_wta__with_stdp::handles_test_event(nest::InstantaneousRateConnectionEvent& dlr, nest::port receptor_type)
{
    // You should usually not change the code in this function.
    // It confirms to the connection management system that we are able
    // to handle @c DataLoggingRequest on port 0.
...
inline void iaf_psc_exp_wta__with_stdp::get_status(DictionaryDatum &__d) const
{
  // parameters/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_C_m, get_C_m());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_tau_m, get_tau_m());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_tau_syn_inh, get_tau_syn_inh());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_tau_syn_exc, get_tau_syn_exc());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_E_L, get_E_L());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_V_reset, get_V_reset());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_R_max, get_R_max());

  // initial values for state variables in ODE or kernel/* generated by directives/WriteInDictionary.jinja2 */ 
  def<long>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_r, get_r());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_V_m, get_V_m());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_normalization_sum, get_normalization_sum());
...
inline void iaf_psc_exp_wta__with_stdp::set_status(const DictionaryDatum &__d)
{
  // parameters/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_C_m = get_C_m();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_C_m, tmp_C_m);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_tau_m = get_tau_m();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_tau_m, tmp_tau_m);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_tau_syn_inh = get_tau_syn_inh();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_tau_syn_inh, tmp_tau_syn_inh);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_tau_syn_exc = get_tau_syn_exc();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_tau_syn_exc, tmp_tau_syn_exc);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_E_L = get_E_L();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_E_L, tmp_E_L);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_V_reset = get_V_reset();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_V_reset, tmp_V_reset);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_R_max = get_R_max();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_R_max, tmp_R_max);

  // initial values for state variables in ODE or kernel/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  long tmp_r = get_r();
  updateValue<long>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_r, tmp_r);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_V_m = get_V_m();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_V_m, tmp_V_m);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_I_kernel_exc__X__exc_spikes = get_I_kernel_exc__X__exc_spikes();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes);
...
#endif /* #ifndef IAF_PSC_EXP_WTA__WITH_STDP */
