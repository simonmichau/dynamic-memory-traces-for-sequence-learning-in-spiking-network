...
#include "stdp__with_iaf_psc_exp_wta.h"
...
nestmlmodule nestmlmodule_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

nestmlmodule::nestmlmodule()
{
#ifdef LINKED_MODULE
...
const std::string
nestmlmodule::name(void) const
{
  return std::string("nestmlmodule"); // Return name of the module
}
...
nestmlmodule::init( SLIInterpreter* i )
{
    ...
    nest::kernel().model_manager.register_node_model<iaf_psc_exp_wta__with_stdp>("iaf_psc_exp_wta__with_stdp");
  

  
  nest::register_connection_model< nest::stdp__with_iaf_psc_exp_wta >( "stdp__with_iaf_psc_exp_wta" );
