...
//      S_.V_m = get_y() * 1.0;/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Declaration.jinja2 */
    //  std::cout << S_.V_m << std::endl;
      ...
      double rate = P_.R_max * std::exp(get_V_m()) / get_normalization_sum();/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Declaration.jinja2 */
      ...
      {
          if (std::find(V_.fixed_spiketimes.begin(), V_.fixed_spiketimes.end(), get_time_cnt()) != V_.fixed_spiketimes.end())
          {
            emit_spike = true;
          }
      }
...
//    const double fixed_weight_epsp = 1;
    TraceTracker_ spikeEventStruct = {e.get_stamp().get_steps() + e.get_delay_steps() - 2,
                                      weight, e.get_sender_node_id(), 0, false, true};
