...
//    const double fixed_weight_epsp = 1;
    ...
    V_.preSynWeights[e.get_sender_node_id()] = weight;  // this just takes into account the STP part TODO revert
//    V_.preSynWeights[e.get_sender().get_node_id()] = 1.;  // TODO this just takes into account the STP part
