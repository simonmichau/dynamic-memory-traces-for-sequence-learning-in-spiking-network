...
inline void iaf_psc_exp_wta__with_stdp_stp::get_status(DictionaryDatum &__d) const
{
  ...
  def<double>(__d, nest::iaf_psc_exp_wta__with_stdp_stp_names::_eta, get_eta());/* generated by directives/WriteInDictionary.jinja2 */
...
inline void iaf_psc_exp_wta__with_stdp_stp::set_status(const DictionaryDatum &__d)
{
  ...
  updateValue<double>(__d, nest::iaf_psc_exp_wta__with_stdp_stp_names::_eta, tmp_eta);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */
  ...
  set_use_variance_tracking(tmp_use_variance_tracking);/* generated by directives/AssignTmpDictionaryValue.jinja2 */
  ...
  set_eta(tmp_eta);/* generated by directives/AssignTmpDictionaryValue.jinja2 */
