...
**/
#ifndef IAF_PSC_EXP_TEST
#define IAF_PSC_EXP_TEST
...
namespace nest
{
namespace iaf_psc_exp_test_names
{
    const Name _r( "r" );
...
*/
class iaf_psc_exp_test : public nest::ArchivingNode
{
public:
  /**
  ...
  **/
  iaf_psc_exp_test(const iaf_psc_exp_test &);
...
private:
  ...
  **/
  ...
  friend class nest::RecordablesMap<iaf_psc_exp_test>;
  friend class nest::UniversalDataLogger<iaf_psc_exp_test>;
  ...
  **/
  struct Buffers_
  {
    Buffers_(iaf_psc_exp_test &);
    Buffers_(const Buffers_ &, iaf_psc_exp_test &);

    /**
     * Logger for all analog data
    **/
    nest::UniversalDataLogger<iaf_psc_exp_test> logger_;
  ...
  static nest::RecordablesMap<iaf_psc_exp_test> recordablesMap_;

}; /* neuron iaf_psc_exp_test */

inline nest::port iaf_psc_exp_test::send_test_event(nest::Node& target, nest::rport receptor_type, nest::synindex, bool)
{
...
inline nest::port iaf_psc_exp_test::handles_test_event(nest::SpikeEvent&, nest::port receptor_type)
{
    // You should usually not change the code in this function.
...
inline nest::port iaf_psc_exp_test::handles_test_event(nest::CurrentEvent&, nest::port receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline nest::port iaf_psc_exp_test::handles_test_event(nest::DataLoggingRequest& dlr, nest::port receptor_type)
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
...
inline void iaf_psc_exp_test::get_status(DictionaryDatum &__d) const
{
  // parameters/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_C_m, get_C_m());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_tau_m, get_tau_m());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_tau_syn_inh, get_tau_syn_inh());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_tau_syn_exc, get_tau_syn_exc());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_t_ref, get_t_ref());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_E_L, get_E_L());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_V_reset, get_V_reset());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_Theta, get_Theta());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_I_e, get_I_e());

  // initial values for state variables in ODE or kernel/* generated by directives/WriteInDictionary.jinja2 */ 
  def<long>(__d, nest::iaf_psc_exp_test_names::_r, get_r());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_V_abs, get_V_abs());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_test_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());
...
inline void iaf_psc_exp_test::set_status(const DictionaryDatum &__d)
{
  // parameters/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_C_m = get_C_m();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_C_m, tmp_C_m);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_tau_m = get_tau_m();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_tau_m, tmp_tau_m);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_tau_syn_inh = get_tau_syn_inh();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_tau_syn_inh, tmp_tau_syn_inh);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_tau_syn_exc = get_tau_syn_exc();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_tau_syn_exc, tmp_tau_syn_exc);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_t_ref = get_t_ref();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_t_ref, tmp_t_ref);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_E_L = get_E_L();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_E_L, tmp_E_L);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_V_reset = get_V_reset();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_V_reset, tmp_V_reset);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_Theta = get_Theta();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_Theta, tmp_Theta);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_I_e = get_I_e();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_I_e, tmp_I_e);

  // initial values for state variables in ODE or kernel/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  long tmp_r = get_r();
  updateValue<long>(__d, nest::iaf_psc_exp_test_names::_r, tmp_r);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_V_abs = get_V_abs();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_V_abs, tmp_V_abs);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_I_kernel_inh__X__inh_spikes = get_I_kernel_inh__X__inh_spikes();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_I_kernel_exc__X__exc_spikes = get_I_kernel_exc__X__exc_spikes();
  updateValue<double>(__d, nest::iaf_psc_exp_test_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes);
