 ...
 *
 *  Generated from NESTML at time: 2022-09-04 16:28:00.329693
**/
...
private:
  ...
  */
  struct Parameters_{    /* generated by directives/MemberDeclaration.jinja2 */ 
    ...
    //!  presynaptic amplitude
    double A_plus;/* generated by directives/MemberDeclaration.jinja2 */ 
  ...
  send( Event& e, const thread tid, const stdp_stp__with_iaf_psc_exp_wtaCommonSynapseProperties& cp )
  {
...

    {
      ...
      **//* generated by directives/Block.jinja2 */ /* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Assignment.jinja2 */ 
          S_.w += ((POST_NEURON_TYPE*)(__target))->get_a_pre__for_stdp_stp(_tr_t);
    ...
    **//* generated by directives/Block.jinja2 */ /* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Assignment.jinja2 */ 
        S_.w = get_u() * get_x() * get_w();/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Assignment.jinja2 */ 
...
stdp_stp__with_iaf_psc_exp_wta< targetidentifierT >::get_status( DictionaryDatum& __d ) const
{
  ...
  def<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_tau_tr_pre, get_tau_tr_pre());  /* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_tau_tr_post, get_tau_tr_post());  /* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_A_plus, get_A_plus());  /* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_A_minus, get_A_minus());
  ...
  ConnectorModel& cm )
{
  ...
  updateValue<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_tau_tr_pre, tmp_tau_tr_pre);  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_tau_tr_post = get_tau_tr_post();
  updateValue<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_tau_tr_post, tmp_tau_tr_post);  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_A_plus = get_A_plus();
  updateValue<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_A_plus, tmp_A_plus);  /* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_A_minus = get_A_minus();
  updateValue<double>(__d, nest::stdp_stp__with_iaf_psc_exp_wta_names::_A_minus, tmp_A_minus);
  ...
  set_A_plus(tmp_A_plus);  /* generated by directives/AssignTmpDictionaryValue.jinja2 */ 
...
stdp_stp__with_iaf_psc_exp_wta< targetidentifierT >::stdp_stp__with_iaf_psc_exp_wta() : ConnectionBase()
{
  ...
  /* generated by directives/MemberInitialization.jinja2 */ 
  P_.A_plus = 0.48; // as real
  /* generated by directives/MemberInitialization.jinja2 */ 
  P_.A_minus = (-(0.24)); // as real
