 ...
 *
 *  Generated from NESTML at time: 2022-08-26 13:45:45.612604
**/
...
inline void iaf_psc_exp_wta::get_status(DictionaryDatum &__d) const
{
  ...
  def<double>(__d, nest::iaf_psc_exp_wta_names::_t_ref, get_t_ref());/* generated by directives/WriteInDictionary.jinja2 */ 
  ...
  def<double>(__d, nest::iaf_psc_exp_wta_names::_I_kernel_inh__X__inh_spikes, get_I_kernel_inh__X__inh_spikes());/* generated by directives/WriteInDictionary.jinja2 */ 
  def<double>(__d, nest::iaf_psc_exp_wta_names::_I_kernel_exc__X__exc_spikes, get_I_kernel_exc__X__exc_spikes());
...
inline void iaf_psc_exp_wta::set_status(const DictionaryDatum &__d)
{
  ...
  updateValue<double>(__d, nest::iaf_psc_exp_wta_names::_t_ref, tmp_t_ref);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  ...
  updateValue<double>(__d, nest::iaf_psc_exp_wta_names::_I_kernel_inh__X__inh_spikes, tmp_I_kernel_inh__X__inh_spikes);/* generated by directives/ReadFromDictionaryToTmp.jinja2 */ 
  double tmp_I_kernel_exc__X__exc_spikes = get_I_kernel_exc__X__exc_spikes();
  updateValue<double>(__d, nest::iaf_psc_exp_wta_names::_I_kernel_exc__X__exc_spikes, tmp_I_kernel_exc__X__exc_spikes);
