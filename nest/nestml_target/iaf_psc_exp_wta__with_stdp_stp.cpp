...
namespace nest
{
    ...
    template <> void RecordablesMap<iaf_psc_exp_wta__with_stdp_stp>::create()
    {
        ...
        insert_(iaf_psc_exp_wta__with_stdp_stp_names::_a_pre__for_stdp_stp, &iaf_psc_exp_wta__with_stdp_stp::get_a_pre__for_stdp_stp);
...
iaf_psc_exp_wta__with_stdp_stp::iaf_psc_exp_wta__with_stdp_stp():ArchivingNode(), P_(), S_(), B_(*this)
{
    ...
    P_.R_max = 100; // as Hz
    /* generated by directives/MemberInitialization.jinja2 */
    P_.tau_tr_pre__for_stdp_stp = 15; // as ms
    /* generated by directives/MemberInitialization.jinja2 */
    P_.tau_tr_post__for_stdp_stp = 30; // as ms
    ...
    S_.V_m = 0; // as mV
    /* generated by directives/MemberInitialization.jinja2 */
    S_.a_pre__for_stdp_stp = 0.0; // as real
    /* generated by directives/MemberInitialization.jinja2 */
    S_.a_post__for_stdp_stp = 0.0; // as real
    /* generated by directives/MemberInitialization.jinja2 */
    ...
    a_pre__for_stdp_stp__iv = get_a_pre__for_stdp_stp();
    a_post__for_stdp_stp__iv = get_a_post__for_stdp_stp();
}
...
iaf_psc_exp_wta__with_stdp_stp::iaf_psc_exp_wta__with_stdp_stp(const iaf_psc_exp_wta__with_stdp_stp& __n):
    ...
    P_.tau_tr_pre__for_stdp_stp = __n.P_.tau_tr_pre__for_stdp_stp;
    P_.tau_tr_post__for_stdp_stp = __n.P_.tau_tr_post__for_stdp_stp;

    // copy state struct S_
    S_.r = __n.S_.r;
    S_.V_m = __n.S_.V_m;
    S_.a_pre__for_stdp_stp = __n.S_.a_pre__for_stdp_stp;
    S_.a_post__for_stdp_stp = __n.S_.a_post__for_stdp_stp;
    ...
    V_.__P__a_pre__for_stdp_stp__a_pre__for_stdp_stp = __n.V_.__P__a_pre__for_stdp_stp__a_pre__for_stdp_stp;
    V_.__P__a_post__for_stdp_stp__a_post__for_stdp_stp = __n.V_.__P__a_post__for_stdp_stp__a_post__for_stdp_stp;
...
void iaf_psc_exp_wta__with_stdp_stp::recompute_internal_variables(bool exclude_timestep) {
    ...
    if (exclude_timestep) {
        ...
        /* generated by directives/MemberInitialization.jinja2 */
        V_.__P__a_pre__for_stdp_stp__a_pre__for_stdp_stp = std::exp((-(V_.__h)) / P_.tau_tr_pre__for_stdp_stp); // as real
        /* generated by directives/MemberInitialization.jinja2 */
        V_.__P__a_post__for_stdp_stp__a_post__for_stdp_stp = std::exp((-(V_.__h)) / P_.tau_tr_post__for_stdp_stp); // as real
        /* generated by directives/MemberInitialization.jinja2 */
...
void iaf_psc_exp_wta__with_stdp_stp::update(nest::Time const & origin,const long from, const long to)
{
    ...
    for ( long lag = from ; lag < to ; ++lag )
    {
        ...
        //    S_.r = get_r() - 1;
        //}/* generated by directives/Statement.jinja2 */ /* generated by directives/SmallStatement.jinja2 */ /* generated by directives/Declaration.jinja2 */


        double rate = P_.R_max * std::exp(get_V_m() / 1.0) / (V_.normalization_sum + std::exp(get_V_m()));
...
iaf_psc_exp_wta__with_stdp_stp::set_spiketime( nest::Time const& t_sp, double offset )
{
    ...
    if ( n_incoming_ )
    {
        ...
        if (history_.size() > 0) {
            ...
            S_.a_post__for_stdp_stp = history_.back().a_post__for_stdp_stp_;
            S_.a_pre__for_stdp_stp = history_.back().a_pre__for_stdp_stp_;
        }
        else {
            S_.a_post__for_stdp_stp = 0.; // initial value for convolution is always 0
            S_.a_pre__for_stdp_stp = 0.; // initial value for convolution is always 0
        }
        ...
        **/
        ...
        if (V_.__h > 1E-12) {
            ...
            double a_post__for_stdp_stp__tmp = V_.__P__a_post__for_stdp_stp__a_post__for_stdp_stp * get_a_post__for_stdp_stp();
            double a_pre__for_stdp_stp__tmp = V_.__P__a_pre__for_stdp_stp__a_pre__for_stdp_stp * get_a_pre__for_stdp_stp();
            /* replace analytically solvable variables with precisely integrated values  *//* generated by directives/AnalyticIntegrationStep_end.jinja2 */
            S_.a_post__for_stdp_stp = a_post__for_stdp_stp__tmp;
            S_.a_pre__for_stdp_stp = a_pre__for_stdp_stp__tmp;
            V_.__h = old___h;
            recompute_internal_variables(true);
        }
        ...
        **/
        ...
        history_.push_back( histentry__iaf_psc_exp_wta__with_stdp_stp( last_spike_
                , get_a_post__for_stdp_stp()
                , get_a_pre__for_stdp_stp()
                , 0
        ) );
    }
    else
...
double
iaf_psc_exp_wta__with_stdp_stp::get_a_pre__for_stdp_stp( double t, const bool before_increment )
{
#ifdef DEBUG
    std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_pre__for_stdp_stp: getting value at t = " << t << std::endl;
#endif
    ...
    {
#ifdef DEBUG
        std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_pre__for_stdp_stp: \thistory empty, returning initial value = " << a_pre__for_stdp_stp__iv << std::endl;
#endif
        // return initial value
        return a_pre__for_stdp_stp__iv;
    }
    ...
    while ( i >= 0 )
    {
        ...
        {
#ifdef DEBUG
            std::cout<<"iaf_psc_exp_wta__with_stdp_stp::get_a_pre__for_stdp_stp: \tspike occurred at history[i].t_ = " << history_[i].t_ << std::endl;
#endif
            S_.a_pre__for_stdp_stp = history_[ i ].a_pre__for_stdp_stp_;
            S_.a_post__for_stdp_stp = history_[ i ].a_post__for_stdp_stp_;
...
#ifdef DEBUG
            std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_pre__for_stdp_stp: \treturning " << get_a_pre__for_stdp_stp() << std::endl;
#endif
            return get_a_pre__for_stdp_stp();       // type: double
        }
        --i;
    }
    ...
    {
        S_.a_pre__for_stdp_stp = history_[ 0 ].a_pre__for_stdp_stp_;
        S_.a_post__for_stdp_stp = history_[ 0 ].a_post__for_stdp_stp_;

#ifdef DEBUG
        std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_pre__for_stdp_stp: \ttrace requested at exact time of history entry 0, returning " << get_a_pre__for_stdp_stp() << std::endl;
#endif
        return get_a_pre__for_stdp_stp();
    }
...
#ifdef DEBUG
    std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_pre__for_stdp_stp: \tfall-through, returning initial value = " << a_pre__for_stdp_stp__iv << std::endl;
#endif
...
double
iaf_psc_exp_wta__with_stdp_stp::get_a_post__for_stdp_stp( double t, const bool before_increment )
{
#ifdef DEBUG
    std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_post__for_stdp_stp: getting value at t = " << t << std::endl;
#endif
    ...
    {
#ifdef DEBUG
        std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_post__for_stdp_stp: \thistory empty, returning initial value = " << a_post__for_stdp_stp__iv << std::endl;
#endif
        // return initial value
        return a_post__for_stdp_stp__iv;
    }
    ...
    while ( i >= 0 )
    {
        ...
        {
#ifdef DEBUG
            std::cout<<"iaf_psc_exp_wta__with_stdp_stp::get_a_post__for_stdp_stp: \tspike occurred at history[i].t_ = " << history_[i].t_ << std::endl;
#endif
            S_.a_pre__for_stdp_stp = history_[ i ].a_pre__for_stdp_stp_;
            S_.a_post__for_stdp_stp = history_[ i ].a_post__for_stdp_stp_;
...
#ifdef DEBUG
            std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_post__for_stdp_stp: \treturning " << get_a_post__for_stdp_stp() << std::endl;
#endif
            return get_a_post__for_stdp_stp();       // type: double
        }
        --i;
    }
...
#ifdef DEBUG
        std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_post__for_stdp_stp: \ttrace requested at exact time of history entry 0, returning " << get_a_post__for_stdp_stp() << std::endl;
#endif
        return get_a_post__for_stdp_stp();
    }

    // this case occurs when the trace was requested at a time before the first spike in the history
    // return initial value propagated in time
#ifdef DEBUG
    std::cout << "iaf_psc_exp_wta__with_stdp_stp::get_a_post__for_stdp_stp: \tfall-through, returning initial value = " << a_post__for_stdp_stp__iv << std::endl;
#endif
