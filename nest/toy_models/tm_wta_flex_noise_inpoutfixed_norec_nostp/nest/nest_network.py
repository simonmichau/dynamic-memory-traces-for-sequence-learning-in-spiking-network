...
if __name__ == '__main__':
    ...
    # TOY EXAMPLE
    grid = Network(grid_shape=(1, 10), k_min=4, k_max=4, n_inputs=50)
    ...
    recorder.run_network(inpgen=inpgen, t_sim=shared_params.sim_time,
                         dt_rec=1000,
                         title="Test #1", train=True, order_neurons=False)
