...
if __name__ == '__main__':
    ...
    # TOY EXAMPLE
    grid = Network(grid_shape=(1, 2), k_min=3, k_max=3, n_inputs=1)

    print(grid.get_node_collections().rate_fraction)
    inpgen = InputGenerator(grid, r_noise=1e-12, r_input=1e-12, r_noise_pattern=1e-12, use_noise=False, t_noise_range=[300.0, 500.0],
