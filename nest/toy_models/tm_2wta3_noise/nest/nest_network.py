...
class InputGenerator(object):
    ...
    def __init__(self, target_network, **kwds):
        ...
        self.r_noise_pattern = kwds.get('r_noise_pattern', 5)
...
if __name__ == '__main__':
    ...
    # TOY EXAMPLE
    grid = Network(grid_shape=(1, 2), k_min=3, k_max=3, n_inputs=10)

    print(grid.get_node_collections().rate_fraction)
    inpgen = InputGenerator(grid, r_noise=5., r_input=1e-12, r_noise_pattern=5., use_noise=True,
    ...
    recorder.run_network(inpgen=inpgen, t_sim=3000, dt_rec=None, title="Test #1", train=True, order_neurons=False)
